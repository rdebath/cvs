...
/* Our task is to start the server and set up the global variables
   to_server and from_server.  Because we have popenRW, we do this
   without calling a special `start_rsh_server()' function. */
void
start_server ()
{
