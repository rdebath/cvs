...
# various defines for things that are OS-specific
...
(cd cvsroot/CVSROOT; ci -q -u -t${NULLFILE} \
...
directory_cmp ()
{
	...
	if diff /tmp/dc$$d1 /tmp/dc$$d2 >${NULLFILE} 2>&1
	then
		:
	else
		ISDIFF=true
...
'O [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* first-dir           =first-dir= .*[/\\]cvs-sanity[/\\]\*
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file6     first-dir           == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file7     first-dir           == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file6     first-dir/dir1      == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file7     first-dir/dir1      == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file6     first-dir/dir1/dir2 == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file7     first-dir/dir1/dir2 == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file14    first-dir           == .*[/\\]cvs-sanity
M [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.2 file6     first-dir           == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file14    first-dir/dir1      == .*[/\\]cvs-sanity
M [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.2 file6     first-dir/dir1      == .*[/\\]cvs-sanity
A [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.1 file14    first-dir/dir1/dir2 == .*[/\\]cvs-sanity
M [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.2 file6     first-dir/dir1/dir2 == .*[/\\]cvs-sanity
F [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]*                     =first-dir= .*[/\\]cvs-sanity[/\\]\*
...
O [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* \[1.1\] first-dir           =first-dir= .*[/\\]cvs-sanity[/\\]\*
U [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.2 file6     first-dir           == .*[/\\]cvs-sanity[/\\]first-dir
U [0-9/]* [0-9:]* '"${PLUS}"'0000 [a-z@][a-z@]* 1.2 file7     first-dir           == .*[/\\]cvs-sanity[/\\]first-dir' \
...
new revision: delete; previous revision: 1.1
		...
		if echo line2 from branch1 | cmp - file1 >${NULLFILE}; then
		...
		cd .. ; killdir first-dir ${CVSROOT_DIRNAME}/first-dir
		;;
	branches)
...
>>>>>>> 1.1.2.1.2.1'
	...
	new) # look for stray "no longer pertinent" messages.
		...
		cd .. ; killdir first-dir ; killdir ${CVSROOT_DIRNAME}/first-dir
		;;
...
"${PROG} [a-z]*: Updating first-dir/subdir/ssdir"
	...
	mflag)
	  for message in '' ' ' '	
	    ...
	    # Clean up
	    cd ..; killdir a-dir ${CVSROOT_DIRNAME}/a-dir
	  done
	  ;;
	errmsg1)
...
"$PROG [update aborted]: cannot rename file foo to CVS/,,foo: Permission denied"
	  ...
	  chmod u+w 1dir
	  cd ..
	  killdir 1 2 ${CVSROOT_DIRNAME}/1dir
	  ;;
