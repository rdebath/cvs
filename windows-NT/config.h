 ...
 */
#define PACKAGE_STRING "Concurrent Versions System (CVS) 1.12.4.1"
...
/*
 * The default RSH client to use, it it has not been specified using the
 * CVS_RSH environment variable.
 *
 * This is actually a poor default since the Windows RSH is broken, but it's
 * better than nothing.
 */
#define RSH_DFLT "rsh"
