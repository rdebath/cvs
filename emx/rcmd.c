...
/* As can be seen, this seems to be an rcmd derived from vms/rcmd.c.
   Probably the wise choice would be to see whether windows-NT/rcmd.c
   is sufficiently portable and if so figure out some way to share it.
   It should be close.  */
