...
static const char *const loginfo_contents[] = {
    ...
    "#\n",
    "# The user may specify a format string (a la printf) as part of the\n",
    "# filter.  The string is composed of a `%' followed by a space, or\n",
    ...
    "#   %{sVv}\n",
    "#\n",
    "# If a space appears after the `%' character (that is, the percent sign\n",
    "# appears by itself), only the name of the repository will be generated.\n",
    "#	 \n",
