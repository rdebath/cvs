...
# Reproduce by: gnulib-tool --import --dir=. --lib=libgnu --source-base=lib --m4-base=m4   alloca alloca-opt atexit gettext pathmax regex restrict save-cwd vasnprintf xalloc xgetcwd xsize
